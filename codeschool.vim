...
hi StatusLine ctermfg=231 ctermbg=59 cterm=bold guifg=#d7d7d7 guibg=#575e61 gui=bold
hi StatusLineNC ctermfg=231 ctermbg=59 cterm=NONE guifg=#d7d7d7 guibg=#575e61 gui=NONE
...
" hi Normal ctermfg=231 ctermbg=16 cterm=NONE guifg=#d7d7d7 guibg=#252c31 gui=NONE
...
hi Comment ctermfg=247 ctermbg=NONE cterm=NONE guifg=#9a9a9a guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#d7d7d7 guibg=#43820d gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#880708 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#d7d7d7 guibg=#1c3657 gui=NONE
hi DiffText ctermfg=231 ctermbg=24 cterm=bold guifg=#d7d7d7 guibg=#204a87 gui=bold
...
hi Identifier ctermfg=113 ctermbg=NONE cterm=NONE guifg=#99c350 guibg=NONE gui=NONE
...
hi NonText ctermfg=59 ctermbg=17 cterm=NONE guifg=#414e58 guibg=NONE gui=NONE
...
hi Special ctermfg=231 ctermbg=NONE cterm=NONE guifg=#d7d7d7 guibg=NONE gui=NONE
...
hi StorageClass ctermfg=113 ctermbg=NONE cterm=NONE guifg=#99c350 guibg=NONE gui=NONE
...
hi Title ctermfg=231 ctermbg=NONE cterm=bold guifg=#d7d7d7 guibg=NONE gui=bold
